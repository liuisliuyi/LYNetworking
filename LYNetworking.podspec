...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/kindom/LYNetworking'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'kindom' => '1034218685@qq.com' }
  s.source           = { :git => 'https://github.com/kindom/LYNetworking.git', :tag => s.version.to_s }
